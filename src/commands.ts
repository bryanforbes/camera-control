...
async openSettings() : Promise<__Result__<null, "NoPortSet" | "Io" | "SerialPort" | "Tauri" | "Store" | "PelcoD">> {
try {
...
async ready() : Promise<__Result__<null, "NoPortSet" | "Io" | "SerialPort" | "Tauri" | "Store" | "PelcoD">> {
try {
...
async setPort(port: string | null) : Promise<__Result__<null, "NoPortSet" | "Io" | "SerialPort" | "Tauri" | "Store" | "PelcoD">> {
try {
...
async getPorts() : Promise<__Result__<string[], "NoPortSet" | "Io" | "SerialPort" | "Tauri" | "Store" | "PelcoD">> {
try {
